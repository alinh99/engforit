...
class SuccessfulEnrollSpeaking extends StatefulWidget {
  static String id = 'enroll_successfully_speaking';
  const SuccessfulEnrollSpeaking({Key key}) : super(key: key);

  @override
  State<SuccessfulEnrollSpeaking> createState() =>
      _SuccessfulEnrollSpeakingState();
}

class _SuccessfulEnrollSpeakingState extends State<SuccessfulEnrollSpeaking> {
